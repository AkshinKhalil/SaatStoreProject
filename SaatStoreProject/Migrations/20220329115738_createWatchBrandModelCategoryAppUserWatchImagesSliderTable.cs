...
{
    public partial class createWatchBrandModelCategoryAppUserWatchImagesSliderTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Glass = table.Column<string>(maxLength: 90, nullable: true),
                    Mechanism = table.Column<string>(maxLength: 90, nullable: true),
                    WaterProtection = table.Column<string>(maxLength: 90, nullable: true),
                    CaseThickness = table.Column<string>(maxLength: 90, nullable: true),
