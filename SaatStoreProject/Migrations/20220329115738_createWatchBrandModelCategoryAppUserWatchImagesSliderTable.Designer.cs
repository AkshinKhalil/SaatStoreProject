...
namespace SaatStoreProject.Migrations
{
    ...
    [Migration("20220329115738_createWatchBrandModelCategoryAppUserWatchImagesSliderTable")]
    partial class createWatchBrandModelCategoryAppUserWatchImagesSliderTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SaatStoreProject.Models.Model", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SaatStoreProject.Models.Brand", b =>
                {
                    b.HasOne("SaatStoreProject.Models.Model", "Model")
                        .WithOne("Brand")
                        .HasForeignKey("SaatStoreProject.Models.Brand", "ModelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("SaatStoreProject.Models.Watch", b =>
                {
                    b.HasOne("SaatStoreProject.Models.Brand", "Brand")
                        .WithOne("Watch")
                        .HasForeignKey("SaatStoreProject.Models.Watch", "BrandId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SaatStoreProject.Models.Category", "Category")
                        .WithOne("Watch")
                        .HasForeignKey("SaatStoreProject.Models.Watch", "CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
